...
export default function Sidebar() {
    return (
        <div className='flex h-screen  flex-col bg-zinc-900 text-white row-span-10 col-span-2'>
            ...
            <div className='px-2 py-4'>
                <ul>
                    <li>
                        <Link href={sidebarItemBottom.href} className='flex items-center px-4 py-2 text-zinc-300 hover:bg-zinc-700 rounded-lg'>
